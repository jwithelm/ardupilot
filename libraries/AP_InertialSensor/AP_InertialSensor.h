...
public:
    ...
    const Vector3f     &get_last_raw_accel(uint8_t i) const { return _last_raw_accel[i]; }
    const Vector3f     &get_last_raw_accel(void) const { return get_last_raw_accel(_primary_accel); }
